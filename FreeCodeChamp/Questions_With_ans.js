...
// Question  =>> Modify the function abTest so that if a or b are less than 0 
...
//which can be a number or a string, and increment or decrement the global count variable according 
//to the card's value (see table). The function will then return a string with the current count and the string Bet if the count is positive, 
...
const myDog = {
  ...
  "legs": 4,
  "tails":  1,
  friends: ['Human', 'other animals']

  // Only change code above this line
};


// Question =>> Read in the property values of testObj using dot notation. 
//Set the variable hatValue equal to the object's property hat and set the variable shirtValue equal 
//to the object's property shirt.
...
console.log(shirtValue)  // The output will be jersey
console.log(hatValue)  // The output will be ballcap
...
console.log(entreeValue)  // the outpur will be hamburger
console.log(drinkValue)   // The output will he water 
